            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="download (2).jpg" class="img-fluid" alt="Responsive image">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>Classic Jeans</h3>
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="download (1).jpg" class="img-fluid" alt="Responsive image" style="width:350px , height:438px">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3> Denim Jeans</h3>
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail"style="width:350px , height:438px;">
                            <a href="cart.php">
                                <img src="download.jpg" height:500px width:200 class="img-fluid" alt="Responsive image" >
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>Fancy Jeans</h3>
                ...
                <div class="row">
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail" style="width:120px , height=120px;">
                            <a href="cart.php">
                                <img src="download (5).jpg" class="img-fluid" alt="Responsive image">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>Stylish Jeans</h3>
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="download (4).jpg" class="img-fluid" alt="Responsive image">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>Lovely Top</h3>
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="download (6).jpg" class="img-fluid" alt="Responsive image" style="width:350px , height:438px">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3> Zara Fancy Top</h3>
                                    <p>Price: &#8377; 1500.00</p>
                                    <?php if(!isset($_SESSION['email'])){  ?>
                                        <p><a href="login.php" role="button" class="btn btn-primary btn-block">Buy Now</a></p>
                                        <?php
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail"style="width:350px , height:438px;">
                            <a href="cart.php">
                                <img src="download (3).jpg" class="img-fluid" alt="Responsive image" >
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>Full Sleves Top</h3>
                                    <p>Price: &#8377; 200.00</p>
                                    <?php if(!isset($_SESSION['email'])){  ?>
                                        <p><a href="login.php" role="button" class="btn btn-primary btn-block">Buy Now</a></p>
                                        <?php
                ...
                <div class="row">
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail" style="width:120px , height=120px;">
                            <a href="cart.php">
                                <img src="OIP (1).jpg" class="img-fluid" alt="Responsive image">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>Professional Shirts</h3>
                                    <p>Price: &#8377; 3600.00</p>
                                    <?php if(!isset($_SESSION['email'])){  ?>
                                        <p><a href="login.php" role="button" class="btn btn-primary btn-block">Buy Now</a></p>
                                        <?php
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="OIP (2).jpg" class="img-fluid" alt="Responsive image">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>Classic Shirt</h3>
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="OIP (4).jpg" class="img-fluid" alt="Responsive image" style="width:350px , height:438px">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3> Blue Shirt</h3>
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail"style="width:350px , height:438px;">
                            <a href="cart.php">
                                <img src="OIP (3).jpg" class="img-fluid" alt="Responsive image" >
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>Fancy Shirt</h3>
                ...
                <div class="row">
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/images (6).jpg" class="img-fluid" alt="Responsive image">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>Cute Phone Cover</h3>
                                    <p>Price: &#8377; 600.00</p>
                                    <?php if(!isset($_SESSION['email'])){  ?>
                                        <p><a href="login.php" role="button" class="btn btn-primary btn-block">Buy Now</a></p>
                                        <?php
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="OIP (5).jpg" class="img-fluid" alt="Responsive image">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>Custom Phone Cover</h3>
                                    <p>Price: &#8377; 400.00</p>
                                    <?php if(!isset($_SESSION['email'])){  ?>
                                        <p><a href="login.php" role="button" class="btn btn-primary btn-block">Buy Now</a></p>
                                        <?php
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/download (3).jpg" class="img-fluid" alt="Responsive image" >
                            </a>
                            <center>
                                <div class="caption">
                                    <h3> Floral Phone Cover</h3>
                                    <p>Price: &#8377; 500.00</p>
                                    <?php if(!isset($_SESSION['email'])){  ?>
                                        <p><a href="login.php" role="button" class="btn btn-primary btn-block">Buy Now</a></p>
                                        <?php
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/download (4).jpg" class="img-fluid" alt="Responsive image">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>Fancy Customized Covers</h3>
                                    <p>Price: &#8377; 500.00</p>
                                    <?php if(!isset($_SESSION['email'])){  ?>
                                        <p><a href="login.php" role="button" class="btn btn-primary btn-block">Buy Now</a></p>
                                        <?php
                ...
                <div class="row">
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/shirt1 (1).jpg" alt="Responsive image">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>Graphic picks </h3>
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/shirt1 (2).jpg" alt="Responsive-image">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>Short sleeves</h3>
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/shirt1 (3).JPG" alt="logo milan">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>Logo Milan</h3>
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/shirt1 (4).jpg" alt="colorblock">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>Colorblock</h3>
